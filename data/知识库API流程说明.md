# 知识库API流程说明
## 1. 新增知识库
- API 地址：`http://172.22.132.118:8081/v1/datasets`
- Method：POST
...
- Response，需要提取其中的 `id`：
    ```json
    {
        "id": "b8f1b858-61d5-4199-8c81-898e07c3eaf5",
        "name": "测试",
        "description": "description",
        "provider": "vendor",
        "permission": "all_team_members",
...
## 2. 修改知识库（直接调用API）
- API 地址：`http://172.22.132.118:8081/v1/datasets/{dataset_id}/document/create-by-file`
- Method：POST
- header: Authorization: Bearer dataset-Y4QLUTrJJLb1Lm57plIzTrQ8
...
## 3. 修改知识库（使用工作流，文档分段会固定采用工作流中预设的规则）
### 3.1 文件上传
...
- API 地址：`http://172.22.132.118:8081/v1/workspaces/current/models/model-types/text-embedding`
- Method：GET
- header: Authorization: Bearer dataset-Y4QLUTrJJLb1Lm57plIzTrQ8
- Response：
    ```json
        ...
        "data": [
            {
                ...
                "icon_small": {
                    "zh_Hans": "http://172.22.132.118:8081/console/api/workspaces/de79cda4-cae0-4be5-8bff-50ddcacf186f/model-providers/langgenius/ollama/ollama/icon_small/zh_Hans",
                    "en_US": "http://172.22.132.118:8081/console/api/workspaces/de79cda4-cae0-4be5-8bff-50ddcacf186f/model-providers/langgenius/ollama/ollama/icon_small/en_US"
                },
                ...
                "models": [
                    {
                        ...
                        "label": {
                            "zh_Hans": "quentinz/bge-large-zh-v1.5:latest",
                            "en_US": "quentinz/bge-large-zh-v1.5:latest"
                        },
